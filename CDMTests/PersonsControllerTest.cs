...
namespace CDMTests
{
    public class PersonsControllerTest
    {
        ...
        private readonly ICountriesGetterService _countriesServie;
        private readonly ILogger<PersonsController> _logger;

        private readonly Mock<ICountriesGetterService> _countiresServiceMock;
        ...
        public PersonsControllerTest()
        {
            ...
            _countiresServiceMock = new Mock<ICountriesGetterService>();
        ...
        public async Task Index_ShouldReturnIndexViewWithPersonsList()
        {
            ...
            PersonsController personsController = new PersonsController(_personsGetterService, _personsAdderService, _personsDeleterService, _personsUpdaterService, _personsSorterService, _countriesServie, _logger);            
